...
from backend.constants import GENERATE_DATA_DESC, NUM_PARTIES_DESC, DATASET_DESC, PATH_DESC, PER_PARTY, \
...
def save_femnist_party_data(nb_dp_per_party, should_stratify, party_folder):
    ...
    :rtype: None
    """
    dataset_path = os.path.join("backend", "datasets", "femnist")
    if not os.path.exists(dataset_path):
        os.makedirs(dataset_path)
...
if __name__ == '__main__':
    ...
    folder = os.path.join("backend", "data")
