...
def get_datahandler_config(dh_name, folder_data, party_id, is_agg):
    if dh_name == 'mnist':
        ...
        if is_agg:
            data['info'] = {
                'npz_file': os.path.join("backend", "datasets", "mnist.npz")
            }
        ...
        if is_agg:
            data['info'] = {
                'txt_file': os.path.join("backend", "datasets", "adult.data")
            }
        ...
        if is_agg:
            data['info'] = {
                'txt_file': os.path.join("backend", "datasets", "nursery.data")
            }
        ...
        if is_agg:
            data['info'] = {
                'data_folder': os.path.join("backend", "datasets", "femnist")
            }
